...
const GridThead = () => {
    ...
    return (
        <thead className={styles.grid__thead}>
            <tr>
                {thead.map((th, index) => (
...
const TheadActionsButton = ({ columnParam }: { columnParam: string }) => {
    ...
    return (
        <svg className={styles.grid__svg__action__button} strokeWidth="0" viewBox="0 0 512 512" onClick={() => showFilterColumn!(columnParam)}>
